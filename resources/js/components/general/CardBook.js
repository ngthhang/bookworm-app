...
export default function CardBook(props) {
  ...
  return (
    <div
      className={`card-book d-flex align-items-stretch ${className}`}
      style={{ height: '33rem' }}
    ...
    >
      ...
      />
      <BookGeneralInfo className="p-3" name={book_title} author={author_name} />
      {book_price !== undefined ? (
        <PriceTag
          className="sticky-bottom"
          discountPrice={discount_price}
          bookPrice={book_price}
          className="bg-light mt-auto p-3"
        />
      ) : null}
    </div>
  );
